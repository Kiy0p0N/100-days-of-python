colors = [
    ...
    "burlywood", "cadet blue", "chartreuse", "chocolate", "coral", "cornflower blue",
    ...
    "khaki", "lavender", "lavender blush", "lawn green", "lemon chiffon", "light blue",
    ...
    "slate gray", "snow", "spring green", "steel blue", "tan", "teal", "thistle",
